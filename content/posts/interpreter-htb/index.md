...
# Reflection
I learned some really cool things during this engagement. The first thing I learned about was that *some boxes are privy to weird characters*, notably the ones found in reverse shells. A straightforward way to get around this is to base64 encode the payload with the many shell-escaping characters it may include.
...
I got to learn about XML Python injection as well as be reminded of SUID manipulation for privilege escalation.
